...
public class User1 {
    ...
    public User1(int id, String nombre, String apellidoP, String apellidoM, String username, String calle, String numero, String colonia, String telefono, String tipo, String email, String pasword) {
        this.id = id;
        this.nombre = nombre;
